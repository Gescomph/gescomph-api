...
namespace WebGESCOMPH.Extensions.Infrastructure
{
    ...
    /// </para>
    /// <para>Por qué: centralizar la configuración y reutilizar conexiones subyacentes del SDK.</para>
    /// <para>Para qué: permitir inyectar <c>Cloudinary</c> y <c>CloudinaryUtility</c> donde se necesiten.</para>
    /// </remarks>
