...
namespace Entity.Infrastructure.Configurations.Business
{
    public class ObligationMonthConfiguration : IEntityTypeConfiguration<ObligationMonth>
    {
        ...
        {
            builder.ToTable("ObligationMonths", DatabaseSchemas.Business);
            ...
            // Idempotencia: índice único por período del contrato
            builder.HasIndex(o => new { o.ContractId, o.Year, o.Month })
                   .IsUnique();
