    ...
    public class FormSeeder : IEntityTypeConfiguration<Form>
    {
        public void Configure(EntityTypeBuilder<Form> builder)
        {
            ...
            builder.HasData(
                ...
                new Form { Id = 3, Name = "Contratos", Description = "Gestión de contratos", Route = "contracts", IsDeleted = false, Active = true, CreatedAt = seedDate },

                new Form { Id = 4, Name = "Citas", Description = "Gestión de Citas", Route = "appointment", IsDeleted = false, Active = true, CreatedAt = seedDate },

                new Form { Id = 5, Name = "Modelos de Seguridad", Description = "Configuración de modelos de seguridad", Route = "security/main", IsDeleted = false, Active = true, CreatedAt = seedDate },
                new Form { Id = 6, Name = "Users", Description = "Gestión de Usuarios", Route = "security/users", IsDeleted = false, Active = true, CreatedAt = seedDate },
