...
namespace Utilities.Messaging.Implements
{
    ...
    public class ConsoleEmailService : ISendCode
    {
        ...
        public Task SendTwoFactorCodeEmailAsync(string emailReceptor, string verificationCode, int validityMinutes, string subject)
        {
            _logger.LogInformation("[ConsoleEmail] TwoFactorCode -> {Email}: {Code} (valid {Minutes}m, subject={Subject})",
