...
namespace Business.Services.SecurityAuthentication
{
    ...
    ) : IAuthService
    {
        ...
        public async Task<RegisterResultDto> RegisterInternalAsync(RegisterDto dto, CancellationToken ct = default)
        {
            ...
            var locationCity = person.CityId > 0
                ? await _cityRepository.GetWithDepartmentAsync(person.CityId)
                : null;
            ...
            return new RegisterResultDto
            {
                ...
                DepartmentId = locationCity?.DepartmentId,
                DepartmentName = locationCity?.Department?.Name
            };
        }
