    ...
    public class SecurityAuthenticationMapping : IRegister
    {
        public void Register(TypeAdapterConfig config)
        {
            ...
            config.NewConfig<User, UserSelectDto>()
               ...
               .Map(dest => dest.DepartmentId, src => src.Person != null && src.Person.City != null ? src.Person.City.DepartmentId : 0)
               .Map(dest => dest.DepartmentName, src => src.Person != null && src.Person.City != null && src.Person.City.Department != null ? src.Person.City.Department.Name : string.Empty)
