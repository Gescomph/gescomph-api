...
public class FormModuleControllerTests
{
    ...
    {
        _service.Setup(s => s.GetByIdAsync(88))
                .ReturnsAsync((FormModuleSelectDto?)null);
    ...
    public async Task GetReturnsOk()
    {
        _service.Setup(s => s.GetAllAsync())
                .ReturnsAsync(new List<FormModuleSelectDto> { new() { Id = 1 } });
    ...
    public async Task PostCreatedAt()
    {
        ...
        _service.Setup(s => s.CreateAsync(It.IsAny<FormModuleCreateDto>()))
    ...
    public async Task PutOk()
    {
        ...
        _service.Setup(s => s.UpdateAsync(It.IsAny<FormModuleUpdateDto>()))
