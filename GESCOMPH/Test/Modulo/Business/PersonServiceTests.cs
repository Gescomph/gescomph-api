...
public class PersonServiceTests
{
    ...
    [Fact]
    public async Task CreateThrowsWhenDuplicateDocument()
    {
        var dto = new PersonDto { Document = "123" };

        _personRepo.Setup(r => r.ExistsByDocumentAsync("123"))
                   .ReturnsAsync(true);
    ...
    public async Task UpdateThrowsWhenNotFound()
    {
        ...
        _personRepo.Setup(r => r.GetByIdAsync(5))
    ...
    [Fact]
    public async Task CreateSucceedsAndMapsSelect()
    {
        ...
        _mapper.Setup(m => m.Map<PersonSelectDto>(createdEntity))
               .Returns(new PersonSelectDto 
               { 
                   Id = 10, 
                   FirstName = "A", 
                   LastName = "B", 
    ...
    [Fact]
    public async Task UpdateSucceedsAndMapsSelect()
    {
        var dto = new PersonUpdateDto 
        { 
            Id = 5, 
        ...
        _mapper.Setup(m => m.Map<PersonSelectDto>(existing))
               .Returns(new PersonSelectDto 
               { 
                   Id = 5, 
                   FirstName = "A2", 
