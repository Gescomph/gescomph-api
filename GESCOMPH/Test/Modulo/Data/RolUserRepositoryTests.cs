...
public class RolUserRepositoryTests
{
    ...
    [Fact]
    public async Task AsignateRolDefaultCreatesRolUser()
    {
    ...
    [Fact]
    public async Task GetRolesByUserIdAsyncReturnsRoles()
    {
        await using var ctx = CreateContext();
        var repo = new RolUserRepository(ctx);
    ...
    [Fact]
    public async Task GetRoleNamesByUserIdAsyncOnlyActiveDistinct()
    {
        await using var ctx = CreateContext();
        var repo = new RolUserRepository(ctx);
    ...
    [Fact]
    public async Task ReplaceUserRolesAsyncReplacesSet()
    {
        await using var ctx = CreateContext();
        var repo = new RolUserRepository(ctx);
