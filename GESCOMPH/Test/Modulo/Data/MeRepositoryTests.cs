...
public class MeRepositoryTests
{
    ...
    [Fact]
    public async Task GetUserWithPersonAsyncReturnsUser()
    {
        ...
        ctx.Users.Add(
            new User
            {
                ...
                Password = "x",
                PersonId = 1,
                Person = new Entity.Domain.Models.Implements.Persons.Person
                {
                    Id = 1,
                    FirstName = "A",
                    LastName = "B",
    ...
    [Fact]
    public async Task GetFormsWithModulesByIdsAsyncReturnsForms()
    {
        await using var ctx = CreateContext();
        var repo = new MeRepository(ctx);
